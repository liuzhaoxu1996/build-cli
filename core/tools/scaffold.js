...
module.exports = {
    ...
    scaffoldList: [], // add default scaffolds
    ...
    moveScaffoldCache(scaffoldName) {
        ...
        require('child_process').execSync(`cd ${scaffoldFolder} && npm i `);
        logUtil.stop();
    ...
    installScaffold(scaffoldName, options) {
        ...
        const order = `cd ${execInstallFolder} && npm install ${scaffoldName}@${hopedVersion} -D`;
